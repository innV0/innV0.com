...
kNNowledge follows a clean, modular architecture built with React, TypeScript, and Zustand.
...
- **AISlice:** AI chat state, messages, and configuration.
- **ReviewSlice:** Staging for AI-proposed changes.
- **HistorySlice:** Model change history and undo/redo.
