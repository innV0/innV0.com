...
The metamodel is the foundation of your kNNowledge project. It defines the "language" you will use to describe your domain.
...
While kNNowledge doesn't support true inheritance yet, you can simulate it by using a generic class and differentiating via relationships.
