...
**Purpose:** This document provides a complete syntax reference for AI assistants working with kNNowledge files and concepts.

**Last Updated:** 2025-12-03

## File Format Overview

kNNowledge uses `.nn.md` files - Markdown files with embedded Mermaid diagrams.
