...
**Purpose:** Guide AI assistants in understanding and generating metamodel structures for iNNfo.
**Naming Rule:** ALWAYS use Natural Language for class names (e.g., "Música", "Project Task").
