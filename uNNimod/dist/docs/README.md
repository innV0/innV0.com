# NN Modeler Documentation

**Version:** 0.1.0

Welcome to **NN Modeler**, a visual modeling tool for creating and managing hierarchical models with metamodel-driven relationships.
...
- [File Format Reference](./02-user-guide/file-format.md) - Understanding `.nn.md` files

- [Architecture](./03-technical-reference/architecture.md) - System design overview

- [AI Context](./06-ai-context/syntax-conventions.md) - For AI assistants working with NN Modeler

## Documentation Structure

### 1. Introduction

- [Overview](./01-introduction/overview.md) - What is NN Modeler?
...
- [Comparativa con Notion](./01-introduction/comparativa-notion.md) - En qué se diferencia de Notion

### 2. User Guide

- [File Format](./02-user-guide/file-format.md) - The `.nn.md` specification
...
- [State Management](./03-technical-reference/state-management.md) - Zustand store
...
Documentation specifically designed for AI assistants to understand NN Modeler's syntax and conventions.
