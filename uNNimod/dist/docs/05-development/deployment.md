...
export default defineConfig({
  plugins: [react()],
  base: '/nn-modeler/', // Replace with your repo name
})
```
...
Access at: `https://[username].github.io/nn-modeler/`
...
NN Modeler follows [Semantic Versioning](https://semver.org/):
...
gh release create v0.2.0 \
  ...
  app/dist/nn-modeler-v0.2.0.zip
```
  ...
  build:
    ...
    steps:
      ...
      - name: Create Archive
        run: |
          cd app/dist
          zip -r ../../nn-modeler-${{ github.ref_name }}.zip .
      
      - name: Create Release
        uses: softprops/action-gh-release@v1
        with:
          files: nn-modeler-${{ github.ref_name }}.zip
