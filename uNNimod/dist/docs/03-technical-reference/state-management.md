...
NN Modeler uses **Zustand** for state management, combined with **Immer** for immutable updates. The store is architected using **Slices** to maintain modularity as the application grows.
