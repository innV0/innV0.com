...
**Purpose:** Guide for AI assistants on how to effectively interact with NN Modeler and generate high-quality proposals.

## Understanding the AI Assistant Role

The AI assistant in NN Modeler is designed to be:
