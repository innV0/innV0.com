...
NN Modeler provides a comprehensive set of features for visual modeling and relationship management.
...
Seven widget types for different relationship patterns:
