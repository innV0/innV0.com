...
**NN Modeler** is a visual modeling tool for creating and managing hierarchical models with metamodel-driven relationships. It enables users to define domain-specific modeling languages through metamodels and build structured models using a simple, human-readable file format.

## What is NN Modeler?

NN Modeler combines three powerful concepts:
...
- [Key Features](./key-features.md) - Explore what NN Modeler can do
...
If you are a regular Notion user, you might find NN Modeler familiar yet different. Check out our [Comparison with Notion](./comparativa-notion.md) to understand the key differences in philosophy and terminology.
