...
**Purpose:** Instructions for Antigravity AI to keep NN Modeler documentation up-to-date.

## Core Principle

After any significant change to NN Modeler, Antigravity should **proactively ask the user** if they want to update the relevant documentation.
...
**Documentation is a first-class citizen** in NN Modeler. Keeping it current ensures:
