...
The Parser (`src/core/parser.ts`) is the core engine of kNNowledge. It handles the bidirectional conversion between the `.nn.md` text format and the internal object model.
