...
**Purpose:** Guide for AI assistants on how to effectively interact with iNNfo and generate high-quality proposals.
**Natural Names:** ALWAYS use Natural Language for classes and nodes.
